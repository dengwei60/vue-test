...
.top {
        ...
        align-items: center;
        background-image: url("./image/5f808255eae7c5b2a075b7699aa690fc.jpg");
        .title {
          color: rgb(255, 140, 0);
          font-size: 50px;
        }
...
<script>
    ...
    let vm = new Vue({
        ...
        computed: {
          ...
          //计算出一个数组,数组的内容是通过判断输入的内容是否包含有本地存储里面的内容来
          //得到这个下拉框要遍历出来的项
            tips:function(){
                let tips = [] //存储下拉框的内容
